...
func TestCanAccessInternalPackage(t *testing.T) {
	testCases := []struct {
		...
		{
			name:           "stdlib package",
			userModulePath: "example-website",
			targetPath:     "fmt",
			expected:       true,
		},
		{
			...
			userModulePath: "example-website",
			targetPath:     "example.com/app/pkg/util",
			expected:       true,
		},
		...
		},
		{
			...
			userModulePath: "example-website",
			targetPath:     "example-website/internal/helpers",
			expected:       true,
		},
		...
		{
			name:           "external internal from a simple module",
			userModulePath: "example-website",
			targetPath:     "example.com/app/internal/ast",
			expected:       false,
		},
		{
...
func TestShouldIncludeInternalPackage(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			userModulePath: "example-website",
			targetPath:     "example.com/app/internal/templater/templater_dto",
			hasModule:      true,
			expected:       true,
		},
